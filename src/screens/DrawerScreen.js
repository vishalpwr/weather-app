  ...
  return (
    <DrawerView style={styles.container}>
      <StatusBar barStyle={'light-content'}
        backgroundColor={isDrawerOpen === 'open' ? colors.sceneBg : colors.screenBg} />
      <View style={styles.iContainer}>
        <View>
          <Animated.Image source={require('../assets/images/sunset.jpeg')}
            style={[styles.bgImage, viewStyles]} />
          <VirtualizedList>
            ...
            <View style={styles.view}>
              ...
              <FlatList
                ...
                renderItem={({ item, index }) =>
                  <HourWeatherItem hour={item.hour} icon={item.icon} temperature={item.temp} />
                }
              />
              <FlatList
                data={days}
                keyExtractor={(item, index) => item.id + index.toString()}
                renderItem={({ item, index }) =>
                  <DaysWeatherItem day={item.day} icon={item.icon} minTemp={item.minTemp}
